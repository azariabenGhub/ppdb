                    ...
                    <tr>
                        <td style="padding: 40px 30px; color: #334155;">
                            ...
                            <p style="font-size: 16px; line-height: 1.6; margin-bottom: 24px; color: #475569;">
                                Anda menerima email ini karena kami menerima permintaan untuk mengatur ulang kata sandi akun Anda di Portal PPDB MI Ziyadatul Ihsan. 
                            ...
                            <p style="font-size: 14px; line-height: 1.6; color: #64748b; background-color: #f8fafc; padding: 15px; border-radius: 8px; border-left: 4px solid #b91c1c; margin-bottom: 24px;">
                                <strong>Catatan:</strong> Tautan pengaturan ulang kata sandi ini berlaku selama 60 menit. Jika Anda tidak merasa meminta pengaturan ulang kata sandi ini, Anda dapat mengabaikan email ini dengan aman.
                            </p>

                            <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 30px 0;">

                            <p style="font-size: 12px; line-height: 1.6; color: #94a3b8; margin: 0;">
                                Jika Anda mengalami kendala saat mengeklik tombol "Atur Ulang Kata Sandi", salin dan tempel tautan berikut ke browser Anda:
                                <br>
