...
class PendaftarController extends Controller
{
    public function index(Request $request)
    {
        ...
        // SEARCH: cari berdasarkan name, email, atau no_pendaftaran
    ...
    public function show($id)
    {
        ...
        // Tambahkan field tambahan untuk kemudahan akses
    ...
    public function formulir($id)
    {
        ...
        $formulir = Formulir::where('user_id', $user->id)->with('verifikasi')->first();
